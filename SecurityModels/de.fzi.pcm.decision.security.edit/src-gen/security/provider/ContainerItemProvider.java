...
/**
 * This is the item provider adapter for a {@link security.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SecurityPackage.Literals.CONTAINER__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SecurityPackage.Literals.CONTAINER__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTimeStampPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_timeStamp_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_timeStamp_feature", "_UI_Container_type"),
				 SecurityPackage.Literals.CONTAINER__TIME_STAMP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addReferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_references_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_references_feature", "_UI_Container_type"),
				 SecurityPackage.Literals.CONTAINER__REFERENCES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SecurityPackage.Literals.CONTAINER__CONTAINS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SecurityPackage.Literals.CONTAINER__CONTAINS,
				 SecurityPatternsFactory.eINSTANCE.createPatternCatalog()));

		newChildDescriptors.add
			(createChildParameter
				(SecurityPackage.Literals.CONTAINER__CONTAINS,
				 SecurityPrerequisitesFactory.eINSTANCE.createPrerequisiteCatalog()));

		newChildDescriptors.add
			(createChildParameter
				(SecurityPackage.Literals.CONTAINER__CONTAINS,
				 SecurityThreatsFactory.eINSTANCE.createThreatCatalog()));
	}
